...
public class CreateAccount_Positive extends projectspecificmethod{
	...
	{
		new loginPage(driver).enterusername(UserName).enterpassword(Password).clickloginbutton().clickCRMSFA().clickAccounts().ClickCreateAccounts().enteraccountname(accountName)
